...
int ShortestPath::shortestPath(uint32_t& source, uint32_t& target, char mode) {
	...
	uint32_t tempId, node_id, comp1 = strongly_conn_.findNodeStronglyConnectedComponentID(source), comp2 = strongly_conn_.findNodeStronglyConnectedComponentID(target);
